...
//
//	Class for simple bounded LTL model checking.
//
#ifndef _SIMPLEBOUNDEDNDFSCHECKER_hh_
#define _SIMPLEBOUNDEDNDFSCHECKER_hh_
#include <list>
#include "natSet.hh"
...
//
//	a variant of the ModelChecker2 class
//
class SimpleBoundedNDFSChecker
{
	NO_COPYING(SimpleBoundedNDFSChecker);
...
public:
	...
	SimpleBoundedNDFSChecker(System& system, LogicFormula& property, int top);
	bool findCounterexample(int maxBound);
...
SimpleBoundedNDFSChecker::getLeadIn() const
{
	return path;
}

inline const list<int>&
SimpleBoundedNDFSChecker::getCycle() const
{
	return cycle;
}
